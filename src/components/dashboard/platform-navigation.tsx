      ...
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        <div className="flex items-center space-x-6">
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Button
              variant="ghost"
              className={isActive('/account') ? 'maxter-text bg-blue-50' : 'text-slate-500'}
            >
            ...
            <Button
              variant="ghost"
              className={isActive('/projects') ? 'maxter-text bg-blue-50' : 'text-slate-500'}
            >
            ...
            <Button
              variant="ghost"
              className={isActive('/team') ? 'maxter-text bg-blue-50' : 'text-slate-500'}
            >
